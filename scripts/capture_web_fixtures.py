...
directory, runs the sort above, and fails on any behaviour change or unexplained value. It needs the docker book, so it is a local pre-merge step, not a CI one.
